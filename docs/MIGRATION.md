...
| Prowlarr | `MPILOT_PROWLARR_URL`, `MPILOT_PROWLARR_DOWNLOAD_URL`, `MPILOT_PROWLARR_API_KEY`, `MPILOT_PROWLARR_IMDB_NATIVE_INDEXER_IDS`, `MPILOT_PROWLARR_IMDB_KEYWORD_INDEXER_IDS`, `MPILOT_PROWLARR_IMDB_DISABLED_INDEXER_IDS`, `MPILOT_PROWLARR_COMPLEMENTARY_INDEXER_IDS` |
