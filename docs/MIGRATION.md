...
| Prowlarr | `MPILOT_PROWLARR_URL`, `MPILOT_PROWLARR_DOWNLOAD_URL`, `MPILOT_PROWLARR_API_KEY`, `MPILOT_PROWLARR_PRIMARY_INDEXER_IDS`, `MPILOT_PROWLARR_FALLBACK_INDEXER_IDS` |
